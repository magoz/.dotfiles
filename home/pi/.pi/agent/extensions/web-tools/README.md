...
- `home/pi/.pi/agent/extensions/web-tools/settings.ts`

## Source of truth

- extension entry: `home/pi/.pi/agent/extensions/web-tools/index.ts`
- settings/defaults: `home/pi/.pi/agent/extensions/web-tools/settings.ts`
- fetch Pi adapter: `home/pi/.pi/agent/extensions/web-tools/webfetch.ts`
- fetch service: `home/pi/.pi/agent/extensions/web-tools/fetch-page.ts`
- public web adapter: `home/pi/.pi/agent/extensions/web-tools/network.ts`
- search Pi adapter: `home/pi/.pi/agent/extensions/web-tools/websearch.ts`
- search service: `home/pi/.pi/agent/extensions/web-tools/search-web.ts`
- Exa provider adapter: `home/pi/.pi/agent/extensions/web-tools/providers/exa.ts`
- Exa protocol parser: `home/pi/.pi/agent/extensions/web-tools/providers/exa-protocol.ts`
- Exa result parser: `home/pi/.pi/agent/extensions/web-tools/providers/exa-results.ts`
- tool output projection: `home/pi/.pi/agent/extensions/web-tools/tool-output.ts`
