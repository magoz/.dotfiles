...
4. runs `provision-env --database`, pulling Development and `test` Vercel variables, removing deployment-only metadata, and creating independent database leases for both;
